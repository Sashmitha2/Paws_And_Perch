...
<div class="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-md">
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-1/2">
            ...
            <form wire:submit.prevent="{{ $editMode ? 'updateReview' : 'addReview' }}" class="space-y-4">
                <div>
                    <label class="block text-gray-700 font-medium mb-1">Rating (1-5):</label>
                    <input type="number" wire:model="rating" min="1" max="5" required
                        class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" />
                ...
                <div class="border border-gray-200 rounded-lg p-4 mb-4 shadow-sm hover:shadow-md transition">
                    ...
                    @if ($review->image)
                        <img src="{{ asset('storage/' . $review->image) }}" 
                                alt="Review Image" class="w-20 h-20 object-cover rounded-full mb-3 shadow border border-gray-300" />
            ...
            @forelse ($reviews as $review)
                <div class="border border-gray-200 rounded-lg p-4 mb-4 shadow-sm hover:shadow-md transition">
                    ...
                    @if ($review->image)
                        <img src="{{ asset('storage/' . $review->image) }}" 
                             alt="Review Image" 
                             class="w-20 h-20 object-cover rounded mb-3 shadow border border-gray-300" />
                    @endif
...
{{-- <div class="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-md">
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="w-full lg:w-1/2">
            ...
            {{-- FORM: Separate for create/update --}}
            {{-- @if ($editMode)
            ...
            @endif
                ...
                <div>
                    <label class="block text-gray-700 font-medium mb-1">Upload Image (optional):</label>
                    <input type="file" wire:model="image" class="block w-full text-gray-600" />
                    @error('image') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                </div>
